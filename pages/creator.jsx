  ...
  return (
    <>
      ...
      <CareerPage
        ...
        header_p1="Creator-designers build media, products, and services for an online audience, using the internet to develop business from their craft."
        header_p2="The creator lifestyle can provide freedom and fulfillment, but requires substantial time and effort to build if you're starting from scratch."
        char_p1="Creators often work alone and rely on self-learning. You cannot go to school to become a creator."
        char_p2="Fortunately, the internet is abundant with resources, tools, and communities for creators."
        char_progressive="85%"
        char_social="38%"
        char_strategic="62%"
      >
