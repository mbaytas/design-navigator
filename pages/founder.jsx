    ...
    <>
      ...
      <div className="career-container">
        <CareerHeader
          title="Founder"
          Icon={Rocket}
          p1="Design-driven founders wield the superpower of combining leadership with product thinking."
          p2="Startup founders may have to drive and navigate profound strategic shifts, which means that job descriptions are seldom set in stone."
          bg_src={bg}
