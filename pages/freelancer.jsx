    ...
    <>
      ...
      <div className="career-container">
        <CareerHeader
          title="Freelancer"
          Icon={Calendar}
          p1="Freelancers are self-employed, usually taking up short-term projects rather than long-term employment."
          p2="Freelancers might be fully independent, or be represented by an agency that markets their work to clients."
          bg_src={bg}
