  ...
  return (
    ...
    >
      <Dialog
        ...
        className="z-50 fixed inset-0 w-screen h-screen bg-black/40 text-white backdrop-blur-2xl flex flex-col justify-center items-center p-6 gap-3 overflow-y-scroll overflow-x-clip"
      >
        ...
        <Dialog.Panel className="">
          <div className="flex flex-col items-start w-full max-w-lg gap-12 p-6 bg-black/90 border-2">
            ...
            <Dialog.Description className="flex flex-col gap-3 text-r1">
              <p className="leading-relaxed opacity-80">
                I have been designing for 20 years, and studying the design
              ...
              <p className="leading-relaxed opacity-50">
                ...
                employee, freelancer, or founder is not simply doing the same
                work in different clothes. It means to immerse yourself in
                different ecosystems, resources, and communities.
              </p>
              <p className="leading-relaxed opacity-80">
                These are different worlds in the multiverse of design.
              </p>
              <p className="leading-relaxed opacity-50">
                It's possible to have great success in any of these worlds. And
                the way to achieve success is commitment. The skills, resources,
                and connections you accumulate compound over time. But move
                between worlds, and you start over.
              </p>
              <p className="leading-relaxed opacity-80">
          ...
          <div className="flex flex-col items-start w-full max-w-lg gap-1 p-6 text-sm leading-normal">
            ...
            <p>
              <span className="opacity-50">Designed and engineered by</span>{" "}
              <a
