...
export default function ResourceCard(props) {
  ...
  return (
    <a
      ...
      target="_blank"
    >
      <div className="flex sd:flex-col items-center sd:justify-center sd:text-center mt-6 mx-4 sd:m-0 gap-2 opacity-50 group-hover:opacity-100 transition-opacity">
        {
          {
            book: <Book size="24" />,
