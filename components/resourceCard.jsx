...
export default function ResourceCard(props) {
  ...
  return (
    ...
    >
      ...
      <div className="w-full grid grid-cols-[6rem_1fr] sd:grid-cols-[12rem_1fr] gap-4 rounded-xl bg-linear-to-b from-white/10 via-white/7 to-white/7 group-hover:bg-white/10 group-active:bg-white/20 group-active:transition-none transition-[background-color,background-image] p-3 relative">
        <Launch
          size="16"
