        ...
        {window !== undefined && (
          <div className="flex flex-col justify-center gap-1 mt-9">
            ...
            <div className="flex items-center justify-center gap-1 px-3 mx-auto">
              <a
                href={`http://twitter.com/share?url=According%20to%20@designdisciplin's%20Design%20Navigator,%20I%20would%20do%20well%20as%20a%20${props.title}.%0A%0AWould%20you%20agree?%0A%0A${window.location.href}`}
                target="_blank"
